...
<form action="" method ="POST"> 
 ...
 <input type="text" name="reg" placeholder="registration number"><br>  <input type="date" name="dob" placeholder="date of birth"><br> 
...
if(isset($_POST['sbtBtn'])) { 
    ...
    $insQuery = mysqli_query($con, "INSERT INTO student VALUES('','$name','$reg','$dob','$dep')"); 
    if($insQuery) { 
