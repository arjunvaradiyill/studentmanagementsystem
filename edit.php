...
$tot = $m1 + $m2 + $m3;
$avg = $tot/3;
$updDetailsQuery = mysqli_query($con, "UPDATE student SET name='$name',dob='$dob',dep='$dep' WHERE reg='$reg'");
$updMarksQuery = mysqli_query($con, "UPDATE marksheet SET sem='$sem',m1='$m1',m2='$m2',m3='$m3',tot='$tot',avg='$avg' WHERE reg='$reg'");
